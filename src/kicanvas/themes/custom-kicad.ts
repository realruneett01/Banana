...
const theme: Theme = {
    name: "custom-kicad",
    friendly_name: "Custom KiCad",
    board: {
        anchor: Color.from_css("rgb(255, 38, 226)"),
        aux_items: Color.from_css("rgb(255, 255, 255)"),
        b_adhes: Color.from_css("rgb(0, 255, 255)"),
        b_crtyd: Color.from_css("rgb(0, 255, 128)"),
        b_fab: Color.from_css("rgb(255, 128, 0)"),
        b_mask: Color.from_css("rgb(0, 255, 0)"),
        b_paste: Color.from_css("rgb(255, 170, 0)"),
        b_silks: Color.from_css("rgb(192, 192, 192)"),
        background: Color.from_css("rgb(0, 16, 35)"),
        cmts_user: Color.from_css("rgb(89, 148, 220)"),
        copper: {
            b: Color.from_css("rgb(0, 0, 255)"),
            f: Color.from_css("rgb(255, 0, 0)"),
            in1: Color.from_css("rgb(0, 17, 170)"),
            in10: Color.from_css("rgb(0, 17, 170)"),
            in11: Color.from_css("rgb(0, 17, 170)"),
            in12: Color.from_css("rgb(0, 17, 170)"),
            in13: Color.from_css("rgb(0, 17, 170)"),
            in14: Color.from_css("rgb(0, 17, 170)"),
            in15: Color.from_css("rgb(0, 17, 170)"),
            in16: Color.from_css("rgb(0, 17, 170)"),
            in17: Color.from_css("rgb(0, 17, 170)"),
            in18: Color.from_css("rgb(0, 17, 170)"),
            in19: Color.from_css("rgb(0, 17, 170)"),
            in2: Color.from_css("rgb(0, 17, 170)"),
            in20: Color.from_css("rgb(0, 17, 170)"),
            in21: Color.from_css("rgb(0, 17, 170)"),
            in22: Color.from_css("rgb(0, 17, 170)"),
            in23: Color.from_css("rgb(0, 17, 170)"),
            in24: Color.from_css("rgb(0, 17, 170)"),
            in25: Color.from_css("rgb(0, 17, 170)"),
            in26: Color.from_css("rgb(0, 17, 170)"),
            in27: Color.from_css("rgb(0, 17, 170)"),
            in28: Color.from_css("rgb(0, 17, 170)"),
            in29: Color.from_css("rgb(0, 17, 170)"),
            in3: Color.from_css("rgb(0, 17, 170)"),
            in30: Color.from_css("rgb(0, 17, 170)"),
            in4: Color.from_css("rgb(0, 17, 170)"),
            in5: Color.from_css("rgb(0, 17, 170)"),
            in6: Color.from_css("rgb(0, 17, 170)"),
            in7: Color.from_css("rgb(0, 17, 170)"),
            in8: Color.from_css("rgb(0, 17, 170)"),
            in9: Color.from_css("rgb(0, 17, 170)"),
        },
        ...
        edge_cuts: Color.from_css("rgb(0, 255, 255)"),
        f_adhes: Color.from_css("rgb(255, 170, 255)"),
        f_crtyd: Color.from_css("rgb(255, 0, 255)"),
        f_fab: Color.from_css("rgb(0, 0, 204)"),
        f_mask: Color.from_css("rgb(204, 0, 204)"),
        f_paste: Color.from_css("rgb(255, 255, 0)"),
        f_silks: Color.from_css("rgb(255, 255, 255)"),
        ...
        margin: Color.from_css("rgb(128, 0, 128)"),
        ...
        user_1: Color.from_css("rgb(255, 0, 0)"),
        user_2: Color.from_css("rgb(0, 170, 0)"),
        user_3: Color.from_css("rgb(0, 0, 255)"),
        user_4: Color.from_css("rgb(255, 255, 0)"),
        user_5: Color.from_css("rgb(128, 0, 128)"),
        user_6: Color.from_css("rgb(255, 165, 0)"),
        user_7: Color.from_css("rgb(0, 191, 255)"),
        user_8: Color.from_css("rgb(255, 105, 180)"),
        user_9: Color.from_css("rgb(0, 255, 127)"),
