...
const theme: Theme = {
    ...
    board: {
        ...
        copper: {
            // NOTE: matches KiCad's own default copper-layer palette exactly
            // (see kicad-default.ts) so pours/zones/tracks on every inner
            // layer render with the same distinct color KiCad itself uses,
            // instead of the old flat rgb(0,17,170) repeated for every
            // In1.Cu-In30.Cu layer.
